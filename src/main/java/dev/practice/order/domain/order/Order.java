...
public class Order extends AbstractEntity {
    ...
    private static final String OPEN_PREFIX = "ord_";
    ...
    private List<OrderAccount> orderAccountList = Lists.newArrayList();
    ...
    public Order(
        ...
        this.orderToken = TokenGenerator.randomCharacterWithPrefix(OPEN_PREFIX);
        this.userId = userId;
        this.payMethod = "KB";
    ...
    public Long calculateTotalAmount() {
        return orderAccountList.stream()
                .mapToLong(OrderAccount::calculateTotalAmount)
                .sum();
    }
    ...
    public void deliveryPrepare() {
        ...
        this.getOrderAccountList().forEach(OrderAccount::deliveryPrepare);
    }
    ...
    public void inDelivery() {
        ...
        this.getOrderAccountList().forEach(OrderAccount::inDelivery);
    }
    ...
    public void deliveryComplete() {
        ...
        this.getOrderAccountList().forEach(OrderAccount::deliveryComplete);
    }
